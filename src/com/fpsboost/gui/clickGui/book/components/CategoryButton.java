...
import com.fpsboost.util.animations.impl.EaseInOutQuad;
...
public class CategoryButton extends Component {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        float adjustment = 0;
        if (category == Category.Boost) adjustment = 2.5f;
     ...
     //   FontUtil.iconFont35.drawCenteredString(category.icon, x + 10 + adjustment, y, color);
        ...
        FontManager.M24.drawString(category.getName(), x + 27 + xDiff, y, color);
