package com.fpsboost.api.betterfps.gui;
...
import com.fpsboost.api.betterfps.BetterFpsHelper;
...
public class GuiBetterFpsConfig extends GuiScreen {
    ...
    private List<GuiButton> initButtons() {
        ...
        buttons.add(new GuiCycleButton.GuiBooleanButton(3, "Fast Box Render", config.fastBoxRender, new String[] {
                        "Whether will only render the exterior of boxes.",
                        "",
                        "Default in Vanilla: Off",
                        "Default in BetterFps: On"
        }));
        buttons.add(new GuiCycleButton.GuiBooleanButton(4, "Fog", config.fog, new String[] {
                        "Whether will render the fog.",
                        "",
                        "Default: On"
        }));
        buttons.add(new GuiCycleButton.GuiBooleanButton(5, "Fast Hopper", config.fastHopper, new String[] {
                        "Whether will improve the hopper.",
                        "",
                        "Default in Vanilla: Off",
                        "Default in BetterFps: On"
        }));
        buttons.add(new GuiCycleButton.GuiBooleanButton(6, "Fast Beacon", config.fastBeacon, new String[] {
