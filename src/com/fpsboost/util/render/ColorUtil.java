...
import static com.fpsboost.util.MathUtils.interpolateFloat;
import static com.fpsboost.util.MathUtils.interpolateInt;

public class ColorUtil implements Access.InstanceAccess {
    ...
    public static Color rainbow(int speed, int index, float saturation, float brightness, float alpha) {
        int angle = (int) ((System.currentTimeMillis() / speed + index) % 360);
        float hue = angle / 360f;
        Color color = new Color(Color.HSBtoRGB(hue, saturation, brightness));
        return new Color(color.getRed(), color.getGreen(), color.getBlue(), Math.max(0, Math.min(255, (int) (alpha * 255))));
    }

    public static Color rainbow(int speed, int index, float saturation) {
        int angle = (int) ((System.currentTimeMillis() / speed + index) % 360);
        float hue = angle / 360f;
        Color color = new Color(Color.HSBtoRGB(hue, saturation, 1));
