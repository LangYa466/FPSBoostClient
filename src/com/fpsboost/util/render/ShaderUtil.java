...
import com.fpsboost.util.FileUtils;
...
public class ShaderUtil implements Access.InstanceAccess {
    ...
    public ShaderUtil(String fragmentShadersrc, boolean notUsed) {
        ...
        try {
            vertexShaderID = createShader(mc.getResourceManager().getResource(new ResourceLocation("FPSBoost/Shaders/vertex.vsh")).getInputStream(), GL_VERTEX_SHADER);
        } catch (IOException e) {
    ...
    public ShaderUtil(String fragmentShaderLoc) {
        this(fragmentShaderLoc, "FPSBoost/Shaders/vertex.vsh");
    }
