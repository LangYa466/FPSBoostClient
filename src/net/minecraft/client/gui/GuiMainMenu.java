...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void drawChangelog() {
        String[] Changelog = {"更新日志" , "[+]Rank系统","[~]重写全部GUI","[~]修改主页面","[~]修复UI拖动问题","[~]语言秒切换","[+]中文输入","[~]修复字体渲染内存泄露问题","[~]修复Rank问题","[+]世界时间修改","[+]材质包显示","[+]物品物理掉落","[+]隐藏聊天框背景","[+]指令系统","[+]插件系统","[+]新的点击页面", "[+]兼容手机", "[~]修复自定义物品位置掉帧", "[+] 自定义记分板", "[+]修改CPSDisplay算法","[~]修改KeyStore代码","[~]修复同模块在同位置同时移动坐标的问题 现在只能每次移动一个"};
        int i = 0;
